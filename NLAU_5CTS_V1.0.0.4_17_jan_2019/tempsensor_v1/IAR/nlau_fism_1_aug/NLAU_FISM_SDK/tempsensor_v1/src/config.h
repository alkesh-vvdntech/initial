...
//#define PERIOD_UPLOAD			2		//in minutes
...
//#define NEXLEAF_SMS_GATEWAY       "+19288572623"
#define NEXLEAF_SMS_GATEWAY          "+919212594827"
#define IST                           22                // Need to update if Device is going in another timezone
#define NEXLEAF_DEFAULT_SERVER_IP "in.coldtrace.org"
#define NEXLEAF_DEFAULT_APN 	  "www."

// Path for getting the configuration from the server
// CONFIGURATION_URL_PATH/IMEI/1/
#define CONFIGURATION_URL_PATH "/coldtrace/ct5demo/config/kvp/v1/"
#define DEVICE_ALARM_URL_PATH "/coldtrace/intel/config/"
#define DEVICE_READY_URL_PATH "/coldtrace/intel/config/"
#define DATA_UPLOAD_URL_PATH "/coldtrace/uploads/l/v4/"
#ifdef _EVIN_BUILD_
...
#define PERIOD_SMS_CHECK   	    5		//poll interval in minutes for sms msg TODO change back
