...
#define LOW_TEMP_THRESHOLD		-15		//deg celsius
#define HIGH_TEMP_THRESHOLD		30		//deg celsius
...
// Path for getting the configuration from the server
// CONFIGURATION_URL_PATH/IMEI/1/
#define CONFIGURATION_URL_PATH "http://undp.coldtrace.org/ct5demo/config/json/v1/"
//#define CONFIGURATION_URL_PATH "www.google.com"

#define DEVICE_ALARM_URL_PATH "http://undp.coldtrace.org/intel/config/"
//#define DEVICE_ALARM_URL_PATH "www.makequotation.com/sample.php"

#define DEVICE_READY_URL_PATH "http://undp.coldtrace.org/intel/config/"
//#define DEVICE_READY_URL_PATH "www.makequotation.com/sample.php"

#define DATA_UPLOAD_URL_PATH "http://undp.coldtrace.org/uploads/fsdk/v1/"
...
#define PERIOD_SMS_CHECK   	    4		//poll interval in minutes for sms msg TODO change back
...
#define PERIOD_UNDEFINED		60
#define PERIOD_SAMPLING			2
#define PERIOD_UPLOAD			10
#define TX_MODE_GPRS_SMS                2
#define TX_MODE_GPRS                    1
#define PERIOD_REBOOT 			1440
#define PERIOD_LCD_OFF			20
#define PERIOD_ALARMS_CHECK	        6
