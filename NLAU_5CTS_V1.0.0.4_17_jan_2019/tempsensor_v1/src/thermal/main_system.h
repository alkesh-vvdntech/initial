...
#define GREEN_LED_OFF           P2OUT &= ~BIT3;
#define GREEN_LED_ON            P2OUT |= BIT3;
#define GREEN_LED_TOGGLE        P2OUT ^= BIT3;

#define RED_LED_ON              P2OUT |=  BIT7;
#define RED_LED_OFF             P2OUT &=  ~BIT7;
#define RED_LED_TOGGLE          P2OUT ^=  BIT7;

#define GREEN_LED2_OFF           P4OUT &= ~BIT7;
#define GREEN_LED2_ON            P4OUT |= BIT7;
#define GREEN_LED2_TOGGLE        P4OUT ^= BIT7;

#define RED_LED2_ON              P4OUT |=  BIT6;
#define RED_LED2_OFF             P4OUT &=  ~BIT6;
#define RED_LED2_TOGGLE          P4OUT ^=  BIT6;
