...
//msp430
#define SPI_CS_L							(P5OUT &= (~BIT7))   //spi cs configuration
#define SPI_CS_H 							(P5OUT |= BIT7)
  
// Chip Select define
#define CS_PxOUT      P7OUT
#define CS_PxDIR      P7DIR
#define CS            BIT3

#define select_card() CS_PxOUT &= ~CS               // Card Select
//#define unselect_card_preinit() CS_PxOUT &= ~CS  // Card Deselect - pre init
#define unselect_card() CS_PxOUT |= CS  // Card Deselect
